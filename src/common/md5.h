...
#define MD5_HASH_SIZE   (MD5_HASH_LEN+1)

#ifndef MD5_BUFFSIZE
#define MD5_BUFFSIZE    1024
#endif
...
extern void MD5Init(MD5_CTX *mdContext, unsigned int pseudoRandomNumber);

extern void MD5Update(MD5_CTX *mdContext, unsigned char *inBuf, unsigned int inLen);

extern void MD5Final(MD5_CTX *mdContext);

extern void MD5HashString(unsigned char *source, unsigned int size, unsigned int seed, char hash[MD5_HASH_SIZE]);
